...
function greet(firstVisit) {
  ...
  var greetings = ["Hello", "Hi", "Howdy", "Bonjour", "Hiya", "Greetings", "Howdy-do", "Cheers", "Hey", "Heyyy", "Ahoy", "G’day", "Heya"];
  var greeting;
